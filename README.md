...
The X-Touch Mini must be configured in "standard" mode (not MCU mode) for this to work properly, I have had a poor experience trying to use the MCU mode so found it better to work from scratch.
